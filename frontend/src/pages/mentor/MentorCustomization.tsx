...
const MentorCustomization: React.FC = () => {
  ...
  const loadMentor = async () => {
    ...
    if (data) {
      ...
      applyMentorTheme(data.primary_color, data.secondary_color, (data as any).accent_color);
    }
  };
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-4 rounded-2xl border border-border bg-card p-6">
            ...
            <ColorPicker label="Cor de Destaque" value={accentColor} onChange={setAccentColor} description="Usada em botões de ação, badges e elementos interativos" />
            <div>
            ...
            <div className="rounded-2xl border border-border p-6" style={{ background: '#0a0a0f' }}>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="h-12 w-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: primaryColor + '20' }}>
                  <span className="font-display text-xl font-bold" style={{ color: primaryColor }}>{mentorName.charAt(0)}</span>
                </div>
                <p className="font-display font-bold text-foreground">{mentorName}</p>
