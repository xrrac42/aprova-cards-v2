...
BEGIN
  ...
  ELSE
    RETURN QUERY
      ...
      SELECT deduped.id, deduped.front, deduped.back, deduped.discipline_id, deduped.discipline_name,
             deduped.existing_correct_count, deduped.existing_incorrect_count
      FROM (
      ...
      ORDER BY deduped.sort_group, random();
  END IF;
END;
$function$;